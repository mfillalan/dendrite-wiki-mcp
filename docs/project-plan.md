...
- Canonical tracker: see [AI Memory Companion Roadmap](./wiki/ai-memory-companion-roadmap.md).
- [x] Audit DendriteMCP features and classify each relevant pattern as keep, adapt, reject, or defer.
