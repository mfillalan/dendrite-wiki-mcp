...
source-file: packages/memory/src/tokenize.ts
---
...
**Kind:** function · **Source:** [packages/memory/src/tokenize.ts:35](https://github.com/mfillalan/dendrite-wiki-mcp/blob/main/packages/memory/src/tokenize.ts#L35)
