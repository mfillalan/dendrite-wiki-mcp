...
- `wiki_maintenance_inbox` returns grouped JSON for the same proposal and lint queues that drive the browser inbox page, plus action hints for review pages, proposal apply, wiki reads, and lint reruns.
